...
begin
  ...
  try
    ...
    Res.Send<TJSONObject>(LServiceUsuarios.QryCadastrousuarios.ToJSONObject());
...
begin
  ...
  try
    ...
    if LUserFunctions.Append(Req.Body<TJSONObject>) then
      Res.Status(THTTPStatus.Created).Send<TJSONObject>(LServiceUsuarios.QryCadastroUsuarios.ToJSONObject());
  finally
    LServiceUsuarios.Free;
    LUserFunctions.Free;
  end;
